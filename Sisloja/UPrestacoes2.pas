...
procedure TFrmPrestacoes2.BitBtn1Click(Sender: TObject);
...
procedure TFrmPrestacoes2.EdvleExit(Sender: TObject);
    var
    desc:currency;
begin
...
procedure TFrmPrestacoes2.RadioButton3Click(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.BitBtn2Click(Sender: TObject);
    var
...
procedure TFrmPrestacoes2.RadioButton1Click(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.RadioButton2Click(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.BitBtn3Click(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.RadioButton4Click(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.RadioButton4Exit(Sender: TObject);
    var
    desc:currency;
begin
if radiobutton4.Checked = True then
...
procedure TFrmPrestacoes2.RadioButton3Exit(Sender: TObject);
    var
    desc:currency;
begin
   if radiobutton3.Checked = True then
...
procedure TFrmPrestacoes2.BitBtn4Click(Sender: TObject);
var
    vvalor:real;
    vnumdoc : string;
    vprest0 : string;
    ...
    vmodopgto:string;
    vrcliente:string;
    vvltotal,vest,vresult:currency;
    vldif :string;
    textolog,vextenso:string;
    vprtent,vok:boolean;
    iretorno,n0,nx,iconta,nnrdoc:Integer;
    impressora,vquant,sTipodesconto,vdescr,valiq,vint,desconto,vcod1:string;
    nome,nome1,vcpf,n1,n2,cnumerocupom,vnumerocupom,sep,nrdoc,vtxt,vval,final:string;
    faz:Boolean;
    vcontrole,I:Integer;
...
{    iretorno:= Le_status();
    ...
    begin
        ...
        begin
          ...
          Open;
          vcontrole:=Fields[0].asinteger+1;
        end;


        nome := FrmItensVenda1.lbnome.Caption;
        nome1:= nome;
        n0   := length(nome1);
        if n0 > 25 then
        begin
        ...
        if ibdm.IBQClientesCPF.AsString = '' then
            vcpf := '   ';
        iRetorno := Bematech_FI_AbreCupomMFD( vcpf, nome1, ' ' );
       ...
       //     faz:=False;
        ...
        begin
            ...
            begin
                ...
                params[4].AsInteger := IBDM.IBQClientesCODIGO.AsInteger;
                params[5].AsInteger := strtoint(FrmItensVenda1.label22.Caption);
                params[6].AsInteger := 0;
                params[7].AsInteger := 0;
                params[8].AsInteger := 0;
                params[9].AsInteger := 0;
                params[10].AsInteger := 0;
                params[11].AsInteger :=  strtoint(FrmItensVenda1.label21.Caption);
                prepare;
                execquery;
            end;
            ...
            begin
              ...
              begin
                      ...
                      Sep:=',';
                      I := AnsiPos(sep,IBDM.IBQmovimento1VALORUNITARIO.AsString);
                      if I = 0 then
                          begin
                              vtxt := Pchar(IBDM.IBQmovimento1VALORUNITARIO.AsString+'00');
                          end
                         else
                          begin
                              vval := IBDM.IBQmovimento1VALORUNITARIO.AsString + '00';
                              vtxt := Pchar(Copy(vval, 1, I - 1)+Copy(vval, I + 1, 2 ));
                          end;
                          final:= vtxt ;
                          vquant := Pchar(IBDM.IBQmovimento1QUANTIDADE.AsString);

                          vm1[vm2] := strtocurr(IBDM.IBQmovimento1VALORUNITARIO.AsString) * Strtocurr(IBDM.IBQmovimento1QUANTIDADE.AsString);
                          vm2 := vm2 + 1;
                      ...
                      //    If RadioButton8.Checked = True Then Begin sTipoDesconto := '$' End;
                          ...
                          vcod := Pchar(IBDM.IBQmovimento1PRODUTO.AsString);
                          vdescr := Pchar(Copy(IBDM.IBQmovimento1DESCRICAO.AsString,1,28));
                          valiq := '1700';
                          vint := 'I';
                           ...
                           Sep:=',';
                            ...
                            if I = 0 then
                                begin
                                    if StrToInt(eddesconto.Text) < 10 then
                          ...
                          frmPrincipal.Retorno_Impressora();
                           ...
                           vresult := vest - strtocurr(IBDM.IBQmovimento1QUANTIDADE.AsString);
                           vcod1 := IBDM.IBQmovimento1PRODUTO.AsString;
                          with ibdm.Consulta do
                          begin
                              close;
                              sql.Clear;
                          ...
                          begin
                              ...
                              params[1].AsString := cnumerocupom;
                              params[2].AsCurrency := IBDM.IBQmovimento1VALORUNITARIO.Value;
                              params[3].Asstring := IBDM.IBQmovimento1PRODUTO.AsString;
                              params[4].Ascurrency := ibdm.IBQmovimento1QUANTIDADE.Value;
                              params[5].AsInteger := vcontrole;
                              params[6].AsString := '';
                              params[7].AsDate := Int(Now);
                              params[8].AsString:=IBDM.IBQmovimento1DESCRICAO.AsString;
                              params[9].AsInteger := IBDM.IBQmovimento1REF.AsInteger;
                              prepare;
                              execquery;
                          end;
                          commitwork;
                  ...
                  Log('Item: '+ IBDM.IBQmovimento1PRODUTO.AsString+' - '+IBDM.IBQmovimento1DESCRICAO.AsString+' Ref. '+inttostr(IBDM.IBQmovimento1REF.AsInteger)+' Preco: '+FormatCurr('0.00',IBDM.IBQmovimento1VALORUNITARIO.Value) );
    ...
    begin
        ...
        params[0].AsInteger := IBDM.IBQUsuarioCODIGO.Value;
        open;
    ...
    with ibdm.Cheka do
    begin
        textolog := 'Atualiza em doctos condição de pagamento e valor total '+FrmItensVenda1.Ednota.Text;
        LOG(textolog);
    ...
    begin
        ...
        begin
              ...
              textolog := 'Pagamento da entrada, lança ctas recebidas '+FrmItensVenda1.Ednota.Text;
              LOG(textolog);
              ...
              begin
                ...
                sql.Add('values (:p0,:p1,:p2,:p3,:p4,:p5,:p6,:p7,:p8,:p9)');
                params[0].AsInteger := vcont;
                params[1].asstring := FrmItensVenda1.Ednota.Text;
                params[2].AsString := lbnome;
                params[3].AsDateTime := now;
                params[4].AsDatetime := now;
                params[5].AsString := 'E';
                params[6].Asstring := FrmItensVenda1.lbnome.caption;
              ...
              textolog := 'e no caixa '+FrmItensVenda1.Ednota.Text+ ' Valor: '+edvle.Text ;
              LOG(textolog);
              ...
              begin
                  ...
                  params[2].AsString := FrmItensVenda1.Ednota.Text;
              ...
              if vcomissao > 0 then
              begin
                   textolog := 'Lanca comissão da entrada '+FrmItensVenda1.Ednota.Text;
                   LOG(textolog);
                ...
                begin
                    ...
                    params[0].AsInteger := strtoint(FrmItensVenda1.Ednota.Text);
                    params[1].AsInteger := IBDM.IBQUsuarioCODIGO.AsInteger;
        ...
        begin
            ...
            begin
               ...
               textolog := 'Lança entrada futura em Ctas a receber -E '+FrmItensVenda1.Ednota.Text;
               LOG(textolog);
            ...
            begin
                ...
                params[6].AsString := 'E';
                params[7].AsString := FrmItensVenda1.lbnome.Caption;
                prepare;
                ExecQuery;
            end;
    ...
    begin
        ...
        begin
            ...
            vcont := Fields[0].AsInteger + 1;
               ...
               textolog := 'Pagamento a vista, lça no caixa '+FrmItensVenda1.Ednota.Text;
               LOG(textolog);
        ...
        if vcomissao > 0 then
        begin
               textolog := 'Lança comissão venda a vista '+FrmItensVenda1.Ednota.Text;
               LOG(textolog);
            ...
            begin
                ...
                sql.Add('Values(:p0,:p1,:p2,:p3,:p4)');
                params[0].AsInteger := strtoint(FrmItensVenda1.Ednota.Text);
                params[1].AsInteger := IBDM.IBQUsuarioCODIGO.Value;
    ...
    if vtp <> '' then  //   é a prazo
       begin
            if vtp >= '1' then
               ...
               textolog := 'Lança em Ctas a receber -1 '+FrmItensVenda1.Ednota.Text+' Valor-'+edit4.text;
               LOG(textolog);
                    ...
                    if vcomissao1 > 0 then
                    begin
               textolog := 'Lança comissão -1 '+FrmItensVenda1.Ednota.Text;
               LOG(textolog);
            ...
            if vtp >= '2' then
               ...
               textolog := 'Lança em Ctas a receber -2 '+FrmItensVenda1.Ednota.Text+' Valor: '+edit6.text;
               LOG(textolog);
                    ...
                    if vcomissao1 > 0 then
                    begin
               textolog := 'Lança comissão -2 '+FrmItensVenda1.Ednota.Text;
               LOG(textolog);
            ...
            if vtp >= '3' then
               ...
               textolog := 'Lança em Ctas a receber -3 '+FrmItensVenda1.Ednota.Text+' Valor: '+edit8.text;
               LOG(textolog);
                    ...
                    if vcomissao1 > 0 then
                    begin
               textolog := 'Lança comissão -3 '+FrmItensVenda1.Ednota.Text;
               LOG(textolog);
            ...
            if vtp >= '4' then
               ...
               textolog := 'Lança em Ctas a receber -4 '+FrmItensVenda1.Ednota.Text +' Valor: '+edit10.text;
               LOG(textolog);
                    ...
                    if vcomissao1 > 0 then
                    begin
               textolog := 'Lança commissão -4 '+FrmItensVenda1.Ednota.Text;
               LOG(textolog);
                        ...
                        begin
                            ...
                            sql.Add('Values(:p0,:p1,:p2,:p3)');
                            params[0].AsInteger := strtoint(FrmItensVenda1.Ednota.Text);
                            params[1].AsInteger := StrToInt(FrmItensVenda1.Label21.caption);
            ...
            if vtp >= '5' then
               ...
               textolog := 'Lança em Ctas a receber -5 '+FrmItensVenda1.Ednota.Text+' Valor: '+edit12.text;
               LOG(textolog);
                    ...
                    if vcomissao1 > 0 then
                    begin
               textolog := 'Lança commissão -5 '+FrmItensVenda1.Ednota.Text;
               LOG(textolog);
            ...
            if vtp >= '6' then
               ...
               textolog := 'Lança em Ctas a receber -6 '+FrmItensVenda1.Ednota.Text+' Valor: '+edit14.text;
               LOG(textolog);
                    ...
                    if vcomissao1 > 0 then
                    begin
               textolog := 'Lança comissão -6 '+FrmItensVenda1.Ednota.Text;
               LOG(textolog);
                ...
                begin
                    ...
                    begin
                            ...
                            begin
                                ...
                                iRetorno := Bematech_FI_IniciaFechamentoCupomMFD( 'A', '$',  vldif, '00,00' );
                                FrmPrincipal.Analisa_iRetorno();
                                FrmPrincipal.Retorno_Impressora();
                                if iretorno = -2 then
                                begin
                         ...
                         if vldif = '0'  then
                           begin
                            iRetorno := Bematech_FI_FechaCupomResumido('Dinheiro',vpromo);
                            FrmPrincipal.Analisa_iRetorno();
                            FrmPrincipal.Retorno_Impressora();
                           end
                           else
                           begin
                            iRetorno := Bematech_FI_EfetuaFormaPagamentoDescricaoForma('Dinheiro', FormatCurr('0.00',vvltotal),' ');
                            FrmPrincipal.Analisa_iRetorno();
                            FrmPrincipal.Retorno_Impressora();
...
//        Showmessage('Cupom impresso, imprimindo carnê, tecle algo !!');
      ...
      begin
               textolog := 'imprime carne, tipo 1 '+FrmItensVenda1.Ednota.Text;
               LOG(textolog);
...
//          relcarneMP.qrlabel41.Caption := 'CNPJ: '+ibdm.IBQParamCNPJ.AsString;
          relcarneMP.vtit.Caption := 'Documento nº: ' + frmitensvenda1.Ednota.Text;
//          relcarneMP.qrlabel27.Caption := 'Documento nº: ' + frmitensvenda.Ednota.Text;

          relcarneMP.QRLabel2.Caption := 'Data da Compra: ' + datetimetostr(now);
//          relcarneMP.QRLabel28.Caption := 'Data da Compra: ' + Frmnotavenda.Edit4.Text;

          relcarneMP.QRLabel4.Caption := 'Cliente: ' + Frmitensvenda1.lbnome.Caption ;
          relcarneMP.qrlbl1.Caption := Frmitensvenda1.lbnome.Caption ;
          //          relcarneMP.QRLabel29.Caption := 'Cliente: ' + Frmitensvenda.lbnome.Caption + '/' + frmnotavenda.label10.caption;
          relcarneMP.qrlblnome.Caption := Frmitensvenda1.lbnome.Caption ;
          relcarneMP.QRLabel7.Caption := 'Vendedor: ' + Frmitensvenda1.lbvend.Caption + '/' + FrmItensVenda1.ComboBox3.Text;
...
//          relcarneMP.QRLabel33.Caption := vmodopgto;
          with ibdm.Consulta do
              begin
                  ...
                  params[0].AsString := frmitensvenda1.Ednota.Text;
                  prepare;
                  open;
              end;
          ...
          QrpToImg(relcarneMP.QuickRep1,'c:\ti\sisloja\jpgs\'+ frmitensvenda1.Ednota.Text,1);
...
//                    impressora:=Getdefaultprintername();
      ...
      if  vprtent=True then   //( (int(now) = eddtent.Date)  and (edvle.Value > 0) ) then
        begin
               textolog := 'Imprime entrada '+FrmItensVenda1.Ednota.Text+' data:'+Datetimetostr(eddtent.date)+' Valor:'+ Formatcurr('0.00',edvle.value);
               LOG(textolog);
      ...
      //    MudaTamPapel(DMPAPER_USER, 215, 140);
          ...
          Relrecibo2.LBCLIENTE.caption :=  Frmitensvenda1.lbnome.Caption + '/' + ibdm.IBQClientesCODIGO.AsString;
...
{            assignFile(f,'c:\ti\imp.Prn');
      ...
      begin
          ibdm.IBQParam.open;
               textolog := 'Imprime carne, tipo 2 '+FrmItensVenda1.Ednota.Text;
               LOG(textolog);
  ...
  //        MudaTamPapel(DMPAPER_USER, 215, 140);
          ...
          relcarne.vtit.Caption := 'Documento nº: ' + frmitensvenda1.Ednota.Text;
          relcarne.qrlabel27.Caption := 'Documento nº: ' + frmitensvenda1.Ednota.Text;

          relcarne.QRLabel2.Caption := 'Data da Compra: ' + frmitensvenda1.DateEdit1.Text;
          relcarne.QRLabel28.Caption := 'Data da Compra: ' + frmitensvenda1.DateEdit1.Text;

          relcarne.QRLabel4.Caption := 'Cliente: ' + Frmitensvenda1.lbnome.Caption + '/' + frmnotavenda.label10.caption;
          relcarne.QRLabel29.Caption := 'Cliente: ' + Frmitensvenda1.lbnome.Caption + '/' + frmnotavenda.label10.caption;

          relcarne.QRLabel7.Caption := 'Vendedor: ' + Frmitensvenda1.lbvend.Caption + '/' + FrmNotaVenda.Label12.Caption;
          relcarne.QRLabel30.Caption := 'Vendedor: ' + Frmitensvenda1.lbvend.Caption + '/' + FrmNotaVenda.Label12.Caption;
    ...
    //      MudaTamPapel(DMPAPER_USER, 215, 140);
          ...
          QrpToImg(relcarne.QuickRep1,'c:\ti\sisloja\jpgs\'+ frmitensvenda1.Ednota.Text,1);
...
//                    impressora:=Getdefaultprintername();
       ...
       //   end;
               ...
               textolog := '***************** Finalizou a venda '+FrmItensVenda1.Ednota.Text;
               LOG(textolog);
...
procedure TFrmPrestacoes2.edvlliqExit(Sender: TObject);
begin
    edliqui.Value := edvlliq.Value;
end;

procedure TFrmPrestacoes2.eddtent1Exit(Sender: TObject);
begin
    if eddtent.Date < int(now) then
        begin
...
procedure TFrmPrestacoes2.BitBtn5Click(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.edsExit(Sender: TObject);
    var
    v1:integer;
    d,m,y : word;
...
procedure TFrmPrestacoes2.FormActivate(Sender: TObject);
begin



    ibdm.IBQParam.Open;
    Frmprestacoes2.Caption := 'Simulação de Pagamento_'+ibdm.IBQParamLISTA.AsString;
...
procedure TFrmPrestacoes2.edvlsldExit(Sender: TObject);
    var
    v1,v2,v3:currency;
begin
...
procedure TFrmPrestacoes2.Edit7Exit(Sender: TObject);
    var
    tempo:real;
    ctempo:string;
    vdata:TDateTime;
...
procedure TFrmPrestacoes2.Edit9Exit(Sender: TObject);
    var
    tempo:real;
    ctempo:string;
    vdata:TDateTime;
...
procedure TFrmPrestacoes2.Edit11Exit(Sender: TObject);
    var
    tempo:real;
    ctempo:string;
    vdata:TDateTime;
...
procedure TFrmPrestacoes2.Edit13Exit(Sender: TObject);
    var
    tempo:real;
    ctempo:string;
  vdata:TDateTime;
...
procedure TFrmPrestacoes2.Edit15Exit(Sender: TObject);
    var
    tempo:real;
    ctempo:string;
  vdata:TDateTime;
...
procedure TFrmPrestacoes2.Edit5Exit(Sender: TObject);
    var
    tempo:real;
    ctempo:string;
    vdata:TDateTime;
...
procedure TFrmPrestacoes2.FormShow(Sender: TObject);
    var
    desc:currency;
begin
    textolog := '###### Iniciando conclusão da Venda nr '+FrmItensVenda1.Ednota.Text;
    LOG(textolog);
...
procedure TFrmPrestacoes2.eddtentExit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.BtnFecharClick(Sender: TObject);
begin
    Close;
end;

procedure TFrmPrestacoes2.edvlmercExit(Sender: TObject);
begin
    Radiobutton4.Setfocus;
end;

procedure TFrmPrestacoes2.modopgtoExit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.ednrpExit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.ed1Exit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.ed2Exit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.ed3Exit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.ed6Exit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.ed5Exit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.ed4Exit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.Edit4Exit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.Edit6Exit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.Edit8Exit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.Edit10Exit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.Edit12Exit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.Edit14Exit(Sender: TObject);
begin
...
procedure TFrmPrestacoes2.btn1Click(Sender: TObject);
var
 impressora:string;
begin
          impressora:=Getdefaultprintername();
